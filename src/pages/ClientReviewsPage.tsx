...
export default function ClientReviewsPage() {
       return (
              <Layout noPaddingTop>
                     <PageMeta
                            title="Client Reviews | 5-Star Rated Marketing Agency — Mind Your Business Media"
                            ...
                            keywords="Mind Your Business Media reviews, performance marketing agency reviews, marketing agency testimonials, client success stories"
                     ...
                     <PageHero
                            label="
 Client Testimonials"
                            title={<>What our clients{" "} <span style={{ color: "#f59e0b" }}>say about us</span></>}
                            description="Our reputation is built on results, not retainers. Hear directly
                     ...
                     <div className="relative z-10 mt-0 md:-mt-[100vh] bg-[#141419]">
                            ...
                            <section className="py-12" style={{ backgroundColor: "#111" }}>
                                   <div className="max-w-4xl mx-auto px-6">
                                          <div
                                                 className="rounded-2xl p-8 md:p-12 text-center glass-panel inner-glow card-3d relative overflow-hidden bg-[#141419]/50"
                                                 style={{
                                                        border: "1px solid #f59e0b30",
                                                 }}
                                          >
                                                 <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#f59e0b]/30 to-transparent" />
                                                 <p
                                   ...
                                   <div className="max-w-7xl mx-auto px-6">
                                          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                                 {clientReviews.map((review) => (
                                                        <div
                                                               key={review.id}
                                                               className="rounded-2xl p-6 transition-all duration-300 hover:translate-y-[-4px] glass-panel inner-glow card-3d relative bg-[#1A1A22]/40"
                                                               style={{
                            ...
                            <section className="py-20" style={{ backgroundColor: "#0a0908" }}>
                                   <div className="max-w-3xl mx-auto px-6 text-center">
                                          ...
                                          <p className="text-lg mb-8" style={{ color: "#9ca3af" }}>
                                                 Join the businesses getting real results — results-driven strategies, just
                                                 performance.
                                          </p>
                                          <a
                                                 href="/free-audit"
