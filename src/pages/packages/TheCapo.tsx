...
import { Check, Shield, TrendingUp, Users, Target, Zap, Share2 } from "lucide-react";
import { Link } from "react-router-dom";

export default function TheCapo() {
    return (
        <Layout noPaddingTop>
            <PageMeta
                title="The Capo Package | Mind Your Business Media"
                description="Stay visible. Stay relevant. Stay untouchable. Dedicated social media and content operation."
                canonicalPath="/packages/the-capo"
            />

            <PageHero
                label="The Social & Content Tier"
                title={
                    <>
                        The Capo <br className="hidden md:block" />
                        <span className="text-primary bg-clip-text text-transparent bg-gradient-to-r from-primary to-rose-400">
                            Package
                        </span>
                    </>
                }
                description="Stay visible. Stay relevant. Stay untouchable. This isn't just posting—it's strategic distribution, audience nurturing, and brand positioning."
            />
            ...
            <div className="relative z-10 mt-0 md:-mt-[100vh] bg-[#141419]">
                ...
                <section className="py-24" style={{ backgroundColor: "#141419" }}>
                    <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-start">
                        <div>
                            ...
                            >
                                Let's be blunt: "posting 3 times a week" doesn't close sales, and buying generic stock photo packages from a cheap agency is actively hurting your local reputation.
                            </p>
                            <p
                                className="text-lg leading-relaxed mb-6"
                                style={{ color: "rgba(244,244,245,0.8)" }}
                            >
                                The Capo Package is our dedicated social media and content operation for home services companies who want to be the undisputed authority in their zip codes. We capture your real work, your real team, and your real expertise, and distribute it systematically across every relevant platform.
                            </p>
                            <p
                                className="text-lg leading-relaxed font-semibold italic"
                                style={{ color: "#af3e4d" }}
                            >
                                We build the trust *before* you even knock on the door. Become the only logical choice in your market.
                            </p>
                        </div>
                        {/* Dual Pricing Layout */}
                        <div className="relative flex flex-col gap-6">
                            ...
                            ></div>
                            <img
                                src="/images/packages/capo.png"
                                alt="Modern urban street level view at night with luxury car"
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div className="p-6 rounded-2xl flex flex-col justify-between relative overflow-hidden glass-panel inner-glow card-3d bg-[#1a1a24]/50">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-3xl font-black text-white mb-1">
                                            $5,000<span className="text-lg text-gray-400">/mo</span>
                                        </p>
                                ...
                                <div className="p-6 rounded-2xl flex flex-col justify-between relative overflow-hidden glass-panel inner-glow card-3d bg-gradient-to-b from-[#af3e4d]/20 to-transparent border border-[#af3e4d]/50 shadow-[0_0_30px_rgba(175,62,77,0.2)]">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-3xl font-black text-white mb-1">
                                            $13,500<span className="text-lg text-gray-400"> total</span>
                                        </p>
                                        <p className="text-xs text-[#10b981] font-bold mb-4">Save $1,500 instantly</p>
                                    </div>
                                    <ul className="text-sm text-gray-400 space-y-2 mb-6 relative z-10">
                ...
                <section className="py-24" style={{ backgroundColor: "#1a1a24" }}>
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center max-w-3xl mx-auto mb-16">
                            ...
                            >
                                Everything required to hold your digital territory.
                            </p>
                        </div>

                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                { icon: Share2, title: "Social Strategy", desc: "Comprehensive Social Media Strategy tailored to your brand" },
                                { icon: Target, title: "Content Creation", desc: "High-quality content creation, curation, and scheduling" },
                                { icon: Zap, title: "Platform Mastery", desc: "Dominate Instagram, LinkedIn, TikTok, and X" },
                                { icon: Users, title: "Community Response", desc: "Active community engagement and audience nurturing" },
                                { icon: TrendingUp, title: "Performance Tracking", desc: "Monthly analytics reporting showing real audience growth" },
                            ].map((item, i) => (
                                <div
                                    key={i}
                        ...
                        <div className="p-10 rounded-3xl relative overflow-hidden glass-panel inner-glow card-3d">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-gray-400 leading-relaxed text-lg">
                                    Brands and operators who know their lack of content is killing their closing rates. When your comfort advisors give a quote, the homeowner looks you up. If your socials look dead or generic, you lose the job to the guy charging 20% more because he looks like the industry authority.
                                </p>
                            </div>
                        </div>
                        <div className="p-10 rounded-3xl relative overflow-hidden glass-panel inner-glow card-3d">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-gray-400 leading-relaxed text-lg">
                                    The Capo handles the territory. They maintain order, keep the name respected, and ensure everyone knows who's in charge. We pump high-value, problem-solving content into your local market until your competitors are irrelevant.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-24 text-center border-t" style={{ borderColor: "rgba(255,255,255,0.05)", backgroundColor: "#0a0a0f" }}>
                    <div className="max-w-3xl mx-auto px-6">
                        <h2 className="text-4xl font-black text-white mb-6">Hold your territory.</h2>
                        <p className="text-xl text-gray-400 mb-10">
                            Apply for The Capo package and let us build an untouchable organic presence.
                        </p>
                        <Link
                            to="/free-audit"
