        ...
        return (
            <Layout noPaddingTop>
                ...
                <PageHero
                    ...
                    title={<>Audit Request <span style={{ color: "#af3e4d" }}>Received</span></>}
                    description="Thank you! We'll review your responses and get back to you with a personalized audit."
                />
                <div className="relative z-10 mt-0 md:-mt-[100vh] bg-[#141419]">
                    ...
                    >
                        <div className="max-w-lg mx-auto px-6 text-center">
                            ...
                            <p className="text-base mb-2" style={{ color: "rgba(244,244,245,0.7)" }}>
                                Thank you, <strong className="text-white">{contactInfo.name}</strong>. We'll review your
                                responses and reach out within <strong className="text-white">1 business day</strong>{" "}
                                with your personalized marketing audit.
                            </p>
                            <p className="text-sm" style={{ color: "rgba(244,244,245,0.5)" }}>
                                Check your inbox at{" "}
                                <strong style={{ color: "#fff" }}>{contactInfo.email}</strong>{" "}
                                for a confirmation.
                            </p>
                        </div>
                    </section>
    ...
    return (
        <Layout noPaddingTop>
            <PageMeta
                ...
                description="Answer a few quick questions about your business and current marketing. We'll deliver a personalized audit with actionable recommendations — results-driven strategies, no obligations."
                canonicalPath="/free-audit"
            />

            <PageHero
                label="Free Performance Audit"
                title={<>Identify Where You're <span style={{ color: "#af3e4d" }}>Leaving Money</span> on the Table</>}
                description="Answer a few quick questions about your business and current marketing. We'll deliver a personalized audit with actionable recommendations — results-driven strategies, no obligations."
            />
            ...
            <div className="relative z-10 mt-0 md:-mt-[100vh] bg-[#141419]">
                ...
                >
                    <div className="max-w-2xl mx-auto px-6">
                        ...
                        {/* Question card */}
                        <div
                            className="rounded-2xl p-8 md:p-10 glass-panel inner-glow card-3d relative overflow-hidden bg-[#1A1A22]/50"
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`w-full text-left px-5 py-3.5 rounded-xl border-2 text-sm font-medium transition-all duration-200 ${selected
                                                        ? "border-[#af3e4d] bg-[#af3e4d]/10 text-[#af3e4d]"
                                                        : "border-[rgba(255,255,255,0.1)] hover:border-[rgba(255,255,255,0.2)] text-[rgba(244,244,245,0.8)]"
                                                        }`}
                                                >
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full px-4 py-3 bg-[#141419] rounded-xl border-2 text-sm text-white focus:outline-none focus:border-[#af3e4d] transition-colors"
                        ...
                        <div className="mt-12 grid sm:grid-cols-3 gap-4 text-center">
                            <div className="flex flex-col items-center gap-2">
                                ...
                                <p className="text-xs font-semibold" style={{ color: "rgba(244,244,245,0.8)" }}>
                                    (856) 350-4733
                                </p>
                            </div>
                            <div className="flex flex-col items-center gap-2">
