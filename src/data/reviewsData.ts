...
export const clientReviews: ClientReview[] = [
 ...
 rating: 5,
 quote:
 "Punctuality, professionalism, and results — that's what you get with Mind Your Business Media. They showed up on time, delivered on every promise, and the results speak for themselves. I've worked with agencies before but none compare.",
 date: "2024-12-03",
