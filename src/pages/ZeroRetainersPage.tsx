...
export default function ZeroRetainersPage() {
       return (
              <Layout noPaddingTop>
                     <PageMeta
                            title="Two Tiers. | Local vs E-Commerce — Mind Your Business Media"
                            description="Choose Local or E-Commerce packages — each with proprietary blends optimized for your market. results-driven strategies, no lock-ins. See which package fits your business."
                            keywords="results-driven marketing, local marketing package, e-commerce marketing, performance marketing tiers, Mind Your Business Media pricing"
                     ...
                     <PageHero
                            label="
 Performance-Based"
                            title={<>Two tiers.{" "} <span style={{ color: "#af3e4d" }}></span></>}
                            description="Whether you serve a local market or sell online, we've built
                     ...
                     <div className="relative z-10 mt-0 md:-mt-[100vh] bg-[#141419]">
                                   ...
                                   <div className="max-w-5xl mx-auto px-6">
                                          <div className="grid md:grid-cols-2 gap-6">
                                                 {[localTier, ecommerceTier].map((tier) => (
                                                        <div
                                                               key={tier.title}
                                                               className="rounded-2xl p-8 text-center glass-panel inner-glow card-3d relative overflow-hidden bg-[#1A1A22]/50"
                                                               style={{
                                                        ...
                                                        <div>
                                                               ...
                                                               <div className="space-y-4">
                                                                      {tier.blend.map((item, i) => (
                                                                             <div
                                                                                    key={item.name}
                                                                                    className="rounded-xl p-5 transition-all hover:scale-[1.01] glass-panel inner-glow card-3d relative overflow-hidden bg-[#1A1A22]/40"
                                                                                    style={{
                                                                                           borderColor: `${tier.accent}20`,
                                                                                    }}
                                                                             >
                                                                                    <div className="gradient-border-top" />
                            ...
                            <section className="py-16" style={{ backgroundColor: "#111" }}>
                                   <div className="max-w-4xl mx-auto px-6 text-center">
                                          ...
                                          <div
                                                 className="rounded-2xl p-8 md:p-10 text-left space-y-6 glass-panel inner-glow card-3d relative overflow-hidden bg-[#1A1A22]/50"
                                                 style={{
