  ...
  return (
    <Layout>
      ...
      <div className="relative z-10 mt-0 md:-mt-[100vh] bg-[#141419]">
          ...
          <div className="container-wide">
            <AnimatedSection>
              <div className="text-center max-w-2xl mx-auto mb-14">
                ...
                <p className="text-body-lg mt-4" style={{ color: "rgba(244, 244, 245, 0.6)" }}>
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {industry.painPoints.map((pain, idx) => (
                <StaggerItem key={pain} direction={idx % 2 === 0 ? "left" : "right"}>
                  <div
                    className="group relative rounded-2xl p-6 glass-panel inner-glow card-3d overflow-hidden"
                  >
        ...
        {/* ═══════════════ 4. ROI CALCULATOR ═══════════════ */}
        <section className="py-20 md:py-28" style={{ background: "rgba(255,255,255,0.03)" }}>
          ...
          <section className="py-20 md:py-28">
            <div className="container-wide">
              <AnimatedSection>
                ...
                <h2 className="heading-section mb-10" style={{ color: "white" }}>
              ...
              <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {industry.industryTrends.map((trend, idx) => (
                  <StaggerItem key={idx} direction="up">
                    <div
                      className="rounded-2xl p-6 h-full glass-panel inner-glow card-3d overflow-hidden relative group"
                    >
                      <div className="gradient-border-top" />
                      <div
                ...
                <div className="max-w-3xl mx-auto">
                  ...
                  >
                    <p
                      ...
                      style={{ color: "white" }}
                    >
                      "We provide what you need when you need it. results-driven strategies, no long-term contracts, no BS — just straight solutions to your marketing problems."
                    </p>
                  </div>
        ...
        {(() => {
          ...
          return industryTools.length > 0 ? (
            <section className="py-16 md:py-20" style={{ background: "rgba(255,255,255,0.02)" }}>
              <div className="container-content">
                <AnimatedSection>
                  <div className="text-center max-w-2xl mx-auto mb-10">
                    ...
                    <p className="mt-3 text-base" style={{ color: "rgba(244, 244, 245, 0.6)" }}>
                ...
                <StaggerContainer className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 max-w-4xl mx-auto">
                  {industryTools.map((tool) => (
                    <StaggerItem key={tool.name} direction="up">
                      <div
                        className="flex flex-col items-center gap-3 p-4 rounded-2xl glass-panel inner-glow card-3d overflow-hidden relative group"
                      >
                        <div className="gradient-border-top" />
                        <div className="w-10 h-10 rounded-xl flex items-center justify-center overflow-hidden bg-[#0C0C0F]">
                          <img
            ...
            <div className="container-wide">
              <AnimatedSection>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-sm font-semibold uppercase tracking-wider" style={{ color: "rgba(244, 244, 245, 0.6)" }}>
          ...
          <section className="py-16 md:py-20" style={{ background: "rgba(255,255,255,0.02)" }}>
            <div className="container-wide">
              <AnimatedSection>
                ...
                <h3 className="heading-subsection mb-8" style={{ color: "white" }}>
              ...
              <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {relatedPosts.map((post) => (
                  <StaggerItem key={post.slug} direction="up">
                    <Link
                      to={`/blog/${post.slug}`}
                      className="block rounded-2xl p-6 glass-panel inner-glow card-3d overflow-hidden relative group h-full"
                    >
                      <div className="gradient-border-top" />
                      <span className="text-xs font-medium" style={{ color: "hsl(352 48% 46%)" }}>
                        {post.category}
                      </span>
                      <h4 className="text-base font-bold mt-2 group-hover:text-[#af3e4d] transition-colors" style={{ color: "white" }}>
                        {post.title}
                      </h4>
                      <p className="text-sm mt-2 line-clamp-2" style={{ color: "rgba(244, 244, 245, 0.6)" }}>
                        {post.excerpt}
                      </p>
        ...
        <section
          ...
          style={{
            background: "linear-gradient(135deg, #141419 0%, #0c0c0f 50%, hsl(352 48% 10%) 100%)",
          }}
        >
          {/* Subtle glow */}
          <div
          ...
          <div className="container-content relative z-10">
            <AnimatedSection>
              <div
                className="text-center rounded-3xl px-8 py-14 md:px-16 md:py-20 glass-panel multilayer-shadow inner-glow relative overflow-hidden"
              >
                <div className="gradient-border-top" />
                <h2
                ...
                >
                  results-driven strategies. No long-term contracts. Just targeted marketing that delivers results for {industry.title.toLowerCase()} companies.
                </p>
...
function FaqAccordionItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div
      className="rounded-xl transition-all duration-300 glass-panel inner-glow relative group overflow-hidden"
    >
      <div className="gradient-border-top" />
      <button
      ...
      >
        <span className="text-sm md:text-base font-semibold pr-4" style={{ color: "white" }}>
          {question}
        </span>
        <ChevronDown
          size={18}
