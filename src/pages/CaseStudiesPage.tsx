...
export default function CaseStudiesPage() {
       ...
       return (
              <Layout noPaddingTop>
                     <PageMeta
                            title="Case Studies | Real Results from Real Clients — Mind Your Business Media"
                            ...
                            keywords="marketing case studies, performance marketing results, ROAS case study, lead generation results, Mind Your Business Media results"
                     ...
                     <PageHero
                            label="
 Verified Results"
                            title={<>Results that speak{" "} <span style={{ color: "#af3e4d" }}>louder than promises</span></>}
                            description="Real data from real clients. No vanity metrics — just revenue,
                                   ...
                                   <div className="max-w-7xl mx-auto px-6">
                                          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                                 {[
                                                        ...
                                                        <div key={s.label} className="text-center p-5 rounded-2xl glass-panel inner-glow card-3d relative overflow-hidden bg-[#141419]/50 transition-all hover:-translate-y-1">
                                                               <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#af3e4d]/30 to-transparent" />
                                          ...
                                          <div className="grid md:grid-cols-2 gap-8">
                                                 {filtered.map((cs) => {
                                                        ...
                                                        return (
                                                               <div
                                                                      key={cs.id}
                                                                      className="rounded-2xl overflow-hidden transition-all duration-300 hover:translate-y-[-4px] glass-panel inner-glow card-3d relative bg-[#1A1A22]/40"
                                                                      style={{
