...
export interface ServicePageData {
 ...
 /* Old way vs Mind Your Business Media way */
 oldWay: string[];
 mybWay: string[];
...
export const servicePages: ServicePageData[] = [
 ...
 slug: "ad-campaigns",
 title: "Ad Campaigns",
 metaTitle: "Ad Campaign Management | Google, Meta & TikTok Ads | Mind Your Business Media",
 metaDescription:
 "Data-driven ad campaigns across Google, Meta, TikTok & YouTube. results-driven strategies — pay for performance. Average 3.52:1 ROAS for our clients.",
 metaKeywords:
 ...
 metaTitle: "SEO Services | Organic Search Marketing | Mind Your Business Media",
 metaDescription:
 "Dominate search results with fully-managed SEO. Position #1 gets 27-39% of all clicks. results-driven strategies — pay for what you need.",
 metaKeywords:
 ...
 metaTitle: "Social Media Marketing | Meta, TikTok & LinkedIn | Mind Your Business Media",
 metaDescription:
 "Strategic social media marketing across Facebook, Instagram, TikTok & LinkedIn. Build brand awareness and drive conversions. results-driven strategies.",
 metaKeywords:
 ...
 metaTitle: "Business Listings Management | Local SEO | Mind Your Business Media",
 metaDescription:
 ...
 metaTitle: "Online Reviews Management | Reputation Building | Mind Your Business Media",
 metaDescription:
 "93% of consumers read reviews before buying. Build trust with automated review requests, monitoring, and response management. results-driven strategies.",
 metaKeywords:
 ...
 metaTitle: "AI Marketing Automation | Chatbots & Workflows | Mind Your Business Media",
 metaDescription:
 "Automate lead follow-up, appointment booking, and marketing workflows with AI. 93% of CMOs report clear ROI from AI. results-driven strategies.",
 metaKeywords:
 ...
 metaTitle: "Website Design & Development | Conversion-Optimized | Mind Your Business Media",
 metaDescription:
 "Custom-coded, conversion-optimized websites. A 0.1s speed improvement lifts conversions 8.4%. Fast, mobile-first, built to convert. results-driven strategies.",
 metaKeywords:
 ...
 metaTitle: "Social Media Account Growth | LinkedIn, YouTube, TikTok & More | Mind Your Business Media",
 metaDescription:
 "Grow your brand across LinkedIn, YouTube, Facebook, Instagram, and TikTok. Build authority, warm up audiences, and reduce your CPL. Pay per usage — results-driven strategies.",
 metaKeywords:
 ...
 mybWay: [
 "Pay per platform, per usage — results-driven strategies",
