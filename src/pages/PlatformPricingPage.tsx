...
export default function PlatformPricingPage() {
       return (
              <Layout noPaddingTop>
                     <PageMeta
                            title="Platform Pricing | Pay-Per-Usage Social Growth — Mind Your Business Media"
                            description="Social media account growth across LinkedIn, YouTube, Facebook, Instagram, and TikTok. Pay per usage — results-driven strategies. Build brand authority and reduce your CPL."
                     ...
                     <PageHero
                            label="
 Pay Per Usage"
                            title={<>Social media growth.{" "} <span style={{ color: "#8b5cf6" }}>results-driven strategies.</span></>}
                            description="Grow your brand across LinkedIn, YouTube, Facebook, Instagram, and
                                   ...
                                   <div className="max-w-7xl mx-auto px-6">
                                          ...
                                          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                                                 {valueProps.map((vp) => (
                                                        <div
                                                               key={vp.title}
                                                               className="rounded-2xl p-6 transition-all hover:-translate-y-1 glass-panel inner-glow card-3d relative bg-[#1A1A22]/40"
                                                               style={{
                                   ...
                                   <div className="max-w-7xl mx-auto px-6">
                                          ...
                                          <div className="space-y-6">
                                                 {platforms.map((platform) => (
                                                        <div
                                                               key={platform.name}
                                                               className="rounded-2xl overflow-hidden transition-all hover:-translate-y-1 glass-panel inner-glow card-3d relative bg-[#141419]/50"
                                                               style={{
                                          ...
                                          {/* Pricing note */}
                                          <div
                                                 className="rounded-2xl p-8 mt-10 text-center glass-panel inner-glow card-3d relative overflow-hidden bg-[#1A1A22]/40"
                                                 style={{
                                                        border: "1px solid #8b5cf630",
                                                 }}
                                          >
                                                 <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#8b5cf6]/30 to-transparent" />
                                                 <p
                                                 ...
                                                 <p
                                                        ...
                                                        style={{ color: "#9ca3af" }}
                                                 >
                                                        data-driven execution. No long-term contracts. Choose the
